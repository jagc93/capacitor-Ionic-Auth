...
module.exports = __webpack_require__(/*! /home/usuario/escritorio/tmp/PROYECTOS_MIOS/capacitorIonic/src/main.ts */"zUnb");
...
/* harmony import */ var _ionic_native_google_plus_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic-native/google-plus/ngx */ "up+p");
/* harmony import */ var _capacitor_community_facebook_login__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @capacitor-community/facebook-login */ "phR/");
...
Object(_capacitor_core__WEBPACK_IMPORTED_MODULE_9__["registerWebPlugin"])(_capacitor_community_facebook_login__WEBPACK_IMPORTED_MODULE_8__["FacebookLogin"]);
let AuthService = class AuthService {
    constructor(afAuth, googlePlus, http) {
        this.afAuth = afAuth;
    ...
    setupFbLogin() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (Object(_ionic_angular__WEBPACK_IMPORTED_MODULE_6__["isPlatform"])('desktop')) {
                this.fb = _capacitor_community_facebook_login__WEBPACK_IMPORTED_MODULE_8__["FacebookLogin"];
            }
            else {
                // Use the native implementation inside a real app!
                const { FacebookLogin } = _capacitor_core__WEBPACK_IMPORTED_MODULE_9__["Plugins"];
    ...
    doRegister(value) {
        return new Promise((resolve, reject) => {
            firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"]()
    ...
    doLoginGoogleAndroid() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const res = yield this.googlePlus.login({
                webClientId: '884850466812-bes25qk9bdql5llklgs1cgenhrtdpds1.apps.googleusercontent.com',
                offline: true,
            });
            return this.afAuth.auth.signInWithCredential(firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider.credential(res.idToken));
        });
    }
    login() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const FACEBOOK_PERMISSIONS = ['email', 'public_profile', 'user_friends'];
            const result = yield this.fb.login({
            ...
            const promise = new Promise((resolve) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                if (result.accessToken && result.accessToken.userId) {
                    ...
                    const result2 = yield this.fb.getCurrentAccessToken();
...
const environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyAHpXDG7VhxZW-n2rCsiVPD2OxtrpE-mhQ',
        authDomain: 'capacitorionic-1.firebaseapp.com',
        projectId: 'capacitorionic-1',
        storageBucket: 'capacitorionic-1.appspot.com',
        messagingSenderId: '884850466812',
        appId: '1:884850466812:web:5b02c6278234966ee79c79',
        measurementId: 'G-3PKD1XPLHB',
    },
};
/*
...
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/fire */ "05qF");
...
/* harmony import */ var _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./services/auth/auth.service */ "9ans");
...
firebase__WEBPACK_IMPORTED_MODULE_14__["initializeApp"](src_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].firebase);
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_6__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].firebase),
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | privacy-policies-privacy-policies-module */ "privacy-policies-privacy-policies-module").then(__webpack_require__.bind(null, /*! ./privacy-policies/privacy-policies.module */ "XA8o")).then(m => m.PrivacyPoliciesPageModule)
    },
